...
function slidesetb(n,bt) {
  ...
  if(n==0){
	...
	let startpb = Date.now(); // запомнить время начала
  	let timeb = 800;
  	let slidewpb = document.querySelector('.slide-color').offsetWidth;
...
swipeActionpb = function() {
  ...
  //document.getElementsByClassName("polu-slider-link")[1].classList.add("link-off");
...
swipeEndpb = function() {
    ...
    //document.getElementsByClassName("polu-slider-link")[1].classList.remove("link-off");
